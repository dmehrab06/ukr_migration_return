...
if os.path.isfile(optimizer_name):
    ...
    opt = Optimizer([(0, 0.0008),(0.0,0.001)], "GP", acq_func="EI",acq_optimizer="sampling",random_state=42)

print('old param',args.input_param1,args.input_param2,flush=True)

try:
    sim_df = get_estimation(str(args.it).zfill(9),dir_name,all_raions,'PL',cache_clean_mode=1)
except:
    next_x = [args.input_param1,args.input_param2]   
...
opt.tell([args.input_param1,args.input_param2],ll)
